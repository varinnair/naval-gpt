...
export default function Home() {
    ...
    const [chunks, setChunks] = useState<NavalChunk[]>([]);
    ...
    const handleSearch = async () => {
        ...
        const results: NavalChunk[] = await searchResponse.json();
    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content={`AI-powered search and chat for the Almanack of Naval Ravikant.`}
                />
                <meta
                    name="viewport"
                ...
                <div className="flex-1 overflow-auto">
                    <div className="mx-auto flex h-full w-full max-w-[750px] flex-col items-center px-3 pt-4 sm:pt-8">
                        ...
                        {loading ? (
                            ...
                            <div className="mt-6 text-center text-lg">{`AI-powered search & chat for the Almanack of Naval Ravikant.`}</div>
                        )}
                    </div>
                </div>
                <Footer />
